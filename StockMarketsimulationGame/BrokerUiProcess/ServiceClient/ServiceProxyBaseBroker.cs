...
{
    public class ServiceProxyBaseBroker<T> : IDisposable where T : class
    {
        ...
        protected ServiceProxyBaseBroker(string serviceEndPointUri, string serviceEndPointConfig)
        {
